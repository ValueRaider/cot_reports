...
class COTReports:
    ...
    def cot_hist(self, cot_report_type = "legacy_fut", store_txt=True, verbose=True):
    ...
    def cot_year(self, year = 2020, cot_report_type = "legacy_fut", store_txt=True, verbose=True):    
    ...
    def cot_all(self, cot_report_type="legacy_fut", store_txt=True, verbose=True): 
    ...
    def cot_all_reports(self, store_txt=True, verbose=True):   
...
_cot_instance = COTReports()
def set_session(session):
    _cot_instance.set_session(session)
def cot_hist(cot_report_type = "legacy_fut", store_txt=True, verbose=True):
    return _cot_instance.cot_hist(cot_report_type, store_txt, verbose)
def cot_year(year = 2020, cot_report_type = "legacy_fut", store_txt=True, verbose=True):
    return _cot_instance.cot_year(year, cot_report_type, store_txt, verbose)
def cot_all(cot_report_type="legacy_fut", store_txt=True, verbose=True):
    return _cot_instance.cot_all(cot_report_type, store_txt, verbose)
def cot_all_reports(store_txt=True, verbose=True):
    return _cot_instance.cot_all_reports(store_txt, verbose)
def cot_description():
    return _cot_instance.cot_description()
